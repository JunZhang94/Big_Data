package com.jp.tic.business.oneCarManyNum.service.impl;
...
@Service
public class OneCarManyNumServiceImpl implements OneCarManyNumService {

	@Autowired
	private OneCarManyNumDao oneCarManyNumDao;
	@Autowired
	...
	public Map<String, Object> queryOneCarManyNumForPages(String json) {
		...
		Map<String, Object> resultMap=oneCarManyNumDao.queryOneCarManyNumForPages(json);

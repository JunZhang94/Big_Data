...
<head>
	...
	<script type="text/javascript" src = '${pageContext.request.contextPath}/app/largeDataHandle/detection-occludedFace.js'></script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:60px;background:#B3DFDA;padding:10px">卡口整合项目</div>
	<div data-options="region:'west',split:true,title:'遮挡面部检测'" style="width:350px;padding:10px;">
		    
		    <div class="div1" style="text-align:padding:5px">
		    	<div style="text-align:center;padding:5px">
		    	<!--  <input type="submit" onchange="show()">-->
		    		<input type="radio" id="show2" name="radioDataSource" value="按车型" checked="checked">按车型
			    	<input type="radio" id="show3" name="radioDataSource" value="按类别">按类别</rd>
		    	</div>
		    </div>
		    <div class="div2" style="text-align:padding:5px;" >
		    	<table>
		    		<tr>
		    			<td>品牌&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    			<td>
		    ...
		    <div class="div3" style="text-align:padding:5px;display:none;">
		    	<table>
		    		<tr>
		    			<td>类型&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    			<td>

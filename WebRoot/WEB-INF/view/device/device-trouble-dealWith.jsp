...
<script type="text/javascript"	src="${pageContext.request.contextPath}/js/client/device/deviceTroubleDealWith.js"></script>
<script type="text/javascript"	src="${pageContext.request.contextPath}/js/client/device/deviceTroubleDealWithWindow.js"></script>

...
<title>图片局部搜车查询</title>
<style type="text/css"> 
.x-grid-panel{
	border:1px solid #99bbe8 !important;
}
</style>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/themes/client/blue/progress-bar.css">
...
<script type="text/javascript"	src="${pageContext.request.contextPath}/js/client/analyze/partImageResult.js"></script>

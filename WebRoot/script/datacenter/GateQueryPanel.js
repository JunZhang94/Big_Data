...
Ext.define("Ext.jp.tic.datacenter.GateQueryPanel", {
	extend: Ext.container.Container,
	
	requireds: [ "Ext.jp.tic.datacenter.GateQueryResultGrid" ],
    ...
    Ext.create("Ext.jp.tic.datacenter.GateQueryResultGrid")
    ],

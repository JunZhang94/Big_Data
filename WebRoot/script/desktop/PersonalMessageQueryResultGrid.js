PersonalMessageResultGrid_DATA_URL = "./batch/task/search.mvc";
Ext.define('Ext.jp.tic.desktop.PersonalMessageQueryResultGrid', {
    ...
    store: Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            method: "POST",
            timeout: 30000,
            url: PersonalMessageQueryResultGrid_DATA_URL,
            /*extraParams: {a: 1, b: 2},*/
            limitParam: "pageSize",
            reader: {
            	type: "json",

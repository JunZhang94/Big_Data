...
Ext.define("Ext.jp.tic.desktop.SystemMessageQueryPanel", {
	extend: Ext.container.Container,
	
	requireds: [ "Ext.jp.tic.desktop.SystemMessageQueryResultGrid" ],
    ...
    Ext.create("Ext.jp.tic.desktop.SystemMessageQueryResultGrid")
    ],

...
var textLable = '';
var buttonLable = '';
//parent.categoryFlag = 'mounts';
categoryFlag = 'mounts';
if (categoryFlag == 'mounts') {
	treeLable = '卡点';
	textLable = '请选择卡口';
	buttonLable = '选择卡口';
...
//查询表单
Jinpeng.categoryQuery.NorthFormPanel = Ext.extend(Ext.Panel,{
	id : 'categoryPanel',
	initComponent : function() {
		...
		Jinpeng.categoryQuery.NorthFormPanel.superclass.initComponent.apply(this);
	},
	//第二种通过纯js方式实现跳转
...
Ext.reg('northFormPanel', Jinpeng.categoryQuery.NorthFormPanel);
//相似车辆串并JS
Ext.ns("Jinpeng.similarityQuery");
...
//查询表单
Jinpeng.similarityQuery.NorthFormPanel = Ext.extend(Ext.Panel,{
	id : 'similarityFormPanel',
	initComponent : function() {
		...
		Jinpeng.similarityQuery.NorthFormPanel.superclass.initComponent.apply(this);
	},
	...
	forwardPage : function(value) {
		var form = Ext.getCmp('brandQueryForm');
		if (form.getForm().isValid()) {
			currentPage = "<span style='font-size:18px;color:#FFFFFF;'>分析研判&nbsp>>&nbsp</span><a href='#' style='font-size:16px;color: #FFFFFF;text-decoration:none;' onclick='currentPages()'>相似车辆串并</a>";
			var url = rootpath + '/carType/generalQueryResultPage.mvc';
			queryUrl =  "/similarity/similarityCarSearch.mvc";
			var title = '相似车辆串并查询结果';
			params = {
				"carNum" : Ext.getCmp('carNumStr').getValue(),
	...
	resetMethod : function() {
		Ext.getCmp('brandQueryForm').getForm().reset();
...
Ext.reg('northFormPanel', Jinpeng.similarityQuery.NorthFormPanel);
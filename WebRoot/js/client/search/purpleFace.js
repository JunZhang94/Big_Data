...
//历史过车查询功能JS
Ext.ns("Jinpeng.purpleFaceQuery");
...
//查询表单
Jinpeng.purpleFaceQuery.NorthFormPanel = Ext.extend(Ext.Panel,{
	id : 'categoryPanel',
	initComponent : function() {
		...
		Jinpeng.purpleFaceQuery.NorthFormPanel.superclass.initComponent.apply(this);
	},
	//第二种通过纯js方式实现跳转
	...
	forwardPage : function(value) {
		var form = Ext.getCmp('pureFaceForm');
...
//				"tagNum":Ext.getCmp('tagNum').getValue(),
	...
	resetMethod : function() {
		clearSelect();
		Ext.getCmp('pureFaceForm').getForm().reset();
...
Ext.reg('northFormPanel', Jinpeng.purpleFaceQuery.NorthFormPanel);
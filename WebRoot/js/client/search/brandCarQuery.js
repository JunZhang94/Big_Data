...
//查询表单
Jinpeng.brandQuery.NorthFormPanel = Ext.extend(Ext.Panel,{
	id : 'brandFormPanel',
	initComponent : function() {
		...
		Jinpeng.brandQuery.NorthFormPanel.superclass.initComponent.apply(this);
	},
...
Ext.reg('northFormPanel', Jinpeng.brandQuery.NorthFormPanel);
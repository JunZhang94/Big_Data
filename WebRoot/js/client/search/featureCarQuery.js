...
//查询表单
Jinpeng.featureQuery.NorthFormPanel = Ext.extend(Ext.Panel,{
	id : 'categoryPanel',
...
//								flex : 0.75,
		...
		Jinpeng.featureQuery.NorthFormPanel.superclass.initComponent.apply(this);
	},
	//第二种通过纯js方式实现跳转
	...
	forwardPage : function(value) {
		...
		if (form.getForm().isValid()) {
			...
			params = {
				...
				"seatbelt":Ext.getCmp('seatbelt').getValue() == false ? '0' : '1',
			...
			conditions = [{
				...
				items :[{
					...
					id : 'sunflag',
					fieldLabel : '遮阳板',
					value:Ext.getCmp('sunflag').getValue()==true?"有":"无",
					anchor : '94%'
				}]
			},{		
				items :[{
					...
					id : 'seatbelt',
					fieldLabel : '无安全带',
					value:Ext.getCmp('seatbelt').getValue()==true?"是":"否",
					anchor : '94%'
				}]
			},{
				items : [ {
...
Ext.reg('northFormPanel', Jinpeng.featureQuery.NorthFormPanel);
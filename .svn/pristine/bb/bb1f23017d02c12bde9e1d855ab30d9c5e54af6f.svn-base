...
Ext.define("Ext.jp.tic.desktop.PersonalMessageQueryPanel", {
	extend: Ext.container.Container,
	
	requireds: [ "Ext.jp.tic.desktop.PersonalMessageQueryResultGrid" ],
    ...
    Ext.create("Ext.jp.tic.desktop.PersonalMessageQueryResultGrid")
    ],

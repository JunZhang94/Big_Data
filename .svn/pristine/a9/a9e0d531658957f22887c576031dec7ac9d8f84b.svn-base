...
Ext.define("Ext.jp.tic.datacenter.DirectionQueryPanel", {
	extend: Ext.container.Container,
	
	requireds: [ "Ext.jp.tic.datacenter.DirectionQueryResultGrid" ],
    ...
    Ext.create("Ext.jp.tic.datacenter.DirectionQueryResultGrid")
    ],

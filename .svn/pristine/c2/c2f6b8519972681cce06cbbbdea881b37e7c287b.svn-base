...
<script type="text/javascript"	src="${pageContext.request.contextPath}/js/client/datacenter/mountOnlineHLineChart.js"></script>
...
<script type="text/javascript"	src="${pageContext.request.contextPath}/js/client/datacenter/mountOnlineStatusByOrg.js"></script>

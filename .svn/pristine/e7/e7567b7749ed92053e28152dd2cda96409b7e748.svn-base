Ext.ns("Jinpeng.dataLineChart");
/**
 * HLineChart
 * 
 * @class Jinpeng.dataLineChart.DataHLineChart
 */
Jinpeng.dataLineChart.DataHLineChart = Ext.extend(Ext.Container, {
	...
	transformData : function(store) {
		...
		store.each(function(record) {
			...
			var lineName = record.get("CAR_TYPE");
	...
	initComponent : function() {
		...
		Jinpeng.dataLineChart.DataHLineChart.superclass.initComponent.apply(this);
	},
	afterRender : function() {
		this.el.dom.innerHTML = "<div id='" + this.chartIDPrefix + "LineHightsChart' >&nbsp;</div>";
		Jinpeng.dataLineChart.DataHLineChart.superclass.afterRender.apply(this);
...
/*				switch (i){
					...
					case 9 : 
						...
						break;
					case 10 : 
						this.dataLineChart.series[i].color = '#C4723C';
						this.dataLineChart.legend.allItems[i].color = '#C4723C';
						break;
					case 11 : 
						this.dataLineChart.series[i].color = '#887B77';
						this.dataLineChart.legend.allItems[i].color = '#887B77';
						break;
					case 12 : 
						this.dataLineChart.series[i].color = '#5EA25E';
						this.dataLineChart.legend.allItems[i].color = '#5EA25E';
						break;
					case 13 : 
						this.dataLineChart.series[i].color = '#33CCCC';
						this.dataLineChart.legend.allItems[i].color = '#33CCCC';
						break;
					case 14 : 
						this.dataLineChart.series[i].color = '#4822DD';
						this.dataLineChart.legend.allItems[i].color = '#4822DD';
						break;
					case 15 : 
						this.dataLineChart.series[i].color = '#AE33CC';
						this.dataLineChart.legend.allItems[i].color = '#AE33CC';
						break;
					case 16 : 
						this.dataLineChart.series[i].color = '#99668F';
						this.dataLineChart.legend.allItems[i].color = '#99668F';
						break;
					case 17 : 
						this.dataLineChart.series[i].color = '#B34D8A';
						this.dataLineChart.legend.allItems[i].color = '#B34D8A';
						break;
					case 18 : 
						this.dataLineChart.series[i].color = '#BB4474';
						this.dataLineChart.legend.allItems[i].color = '#BB4474';
						break;
					case 19 : 
						this.dataLineChart.series[i].color = '#EE11C2';
						this.dataLineChart.legend.allItems[i].color = '#8B008B';
						break;
				}
*/			}
	...
	initHightCharts : function() {
		...
		this.dataLineChart = new Highcharts.Chart({
			...
			tooltip : {
				formatter : function() {
					return '<b>' + this.x + '</b><br/><b>车流量: </b>' + this.y;
				}
			},
			exporting : {
				enabled : false
...
Ext.reg('dataLineChart', Jinpeng.dataLineChart.DataHLineChart);
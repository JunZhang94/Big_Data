...
Ext.define("Ext.jp.tic.datacenter.ProviderQueryPanel", {
	extend: Ext.container.Container,
	
	requireds: [ "Ext.jp.tic.datacenter.ProviderQueryResultGrid" ],
    ...
    Ext.create("Ext.jp.tic.datacenter.ProviderQueryResultGrid")
    ],

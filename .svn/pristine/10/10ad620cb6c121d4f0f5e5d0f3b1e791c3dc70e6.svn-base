 ...
 * HLineChart
 * 
 * @class Jinpeng.mountChart.MountHLineChart
 */
Jinpeng.mountChart.MountHLineChart = Ext.extend(Ext.Container, {
	...
	initComponent : function() {
		...
		Jinpeng.mountChart.MountHLineChart.superclass.initComponent.apply(this);
	},
	afterRender : function() {
		this.el.dom.innerHTML = "<div id='" + this.chartIDPrefix + "LineHightsChart' >&nbsp;</div>";
		Jinpeng.mountChart.MountHLineChart.superclass.afterRender.apply(this);
...
Ext.reg('mountLineChart', Jinpeng.mountChart.MountHLineChart);
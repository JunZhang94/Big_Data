...
Ext.define("Ext.jp.tic.stat.CarTimeRangeAnalyzePanel", {
	extend: Ext.container.Container,
	
	requireds: [ "Ext.jp.tic.stat.CarTimeRangeAnalyzeResultGrid" ],
    ...
    Ext.create("Ext.jp.tic.stat.CarTimeRangeAnalyzeResultGrid")
    ],
